...
const SignUp = () => {
  ...
  return (
    <>
      <div className="card w-100  shadow-xl bg-red-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30">
        <div className="card-body">
          ...
          <small className="text-black mb-2 text-base">Sign Up</small>
          ...
          <form onSubmit={handelSubmit}>
            ...
            <label className="input input-bordered flex items-center gap-2 mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setInput({ ...input, conPassword: e.target.value })
                }
              />
            </label>

            <div className="form-control mb-2 grid gap-2 grid-cols-2 justify-center">
            ...
            <button
              className="btn btn-sm btn-outline btn-neutral  btn-wide"
              type="submit"
              disabled={loading}
            >
            ...
            <Link to="/login">
              <p className="flex justify-center">
                <button
                  className="btn btn-link text-black hover:text-blue-500"
                  type="button"
                >
